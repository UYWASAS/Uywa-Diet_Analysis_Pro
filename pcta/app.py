...
# Sidebar minimal (logout + uploaders)
...
st.markdown(
    "<div class='pcta-muted'>Interfaz modular: vista previa, configuración, resultados, estadística, gráficos y exportación.</div>",
    unsafe_allow_html=True,
)
...
with tabs[1]:
    tab_config_and_run(uploaded_costs_extra=sidebar.uploaded_costs_extra)
